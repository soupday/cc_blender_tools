...
METARIG_EXPORT_RIG = [
    ...
    ["DEF-upper_arm.L", "DEF-shoulder.L", "CC_Base_L_Upperarm", "PLRX"],
    ...
    ["DEF-upper_arm.R", "DEF-shoulder.R", "CC_Base_R_Upperarm", "PLRX"],
    ...
    # Face:
    ["DEF-face", "DEF-spine.006", "CC_Base_FacialBone", "+PLR", "ORG-face"],
    # Jaw:
    ["DEF-jaw", "DEF-spine.006", "CC_Base_JawRoot", "+PLR", "jaw_master"],
]

CC_EXPORT_RIG = [
    # Spine, Neck & Head:
    ["root", "", "CC_Base_BoneRoot", "PLRA"],
    ["DEF-spine", "root", "CC_Base_Hip", "PLRO"],
    ["DEF-pelvis", "DEF-spine", "CC_Base_Pelvis", "PLRA"],
    ["DEF-spine.001", "DEF-spine", "CC_Base_Waist", "PLRA"],
    ["DEF-spine.002", "DEF-spine.001", "CC_Base_Spine01", "PLRA"],
    ["DEF-spine.003", "DEF-spine.002", "CC_Base_Spine02", "PLRA"],
    ["DEF-spine.004", "DEF-spine.003", "CC_Base_NeckTwist01", "PLRA"],
    ["DEF-spine.005", "DEF-spine.004", "CC_Base_NeckTwist02", "PLRA"],
    ["DEF-spine.006", "DEF-spine.005", "CC_Base_Head", "PLRA"],
    # Left Breast:
    ["DEF-breast_twist.L", "DEF-spine.003", "CC_Base_L_RibsTwist", "PLRA"],
    ["DEF-breast.L", "DEF-breast_twist.L", "CC_Base_L_Breast", "PLRA"],
    # Right Breast:
    ["DEF-breast_twist.R", "DEF-spine.003", "CC_Base_R_RibsTwist", "PLRA"],
    ["DEF-breast.R", "DEF-breast_twist.R", "CC_Base_R_Breast", "PLRA"],
    # Left Leg:
    ["DEF-thigh.L", "DEF-pelvis", "CC_Base_L_Thigh", "PLRA"],
    ["DEF-thigh.L.001", "DEF-thigh.L", "CC_Base_L_ThighTwist", "PLRA"],
    ["DEF-shin.L", "DEF-thigh.L.001", "CC_Base_L_Calf", "PLRA"],
    ["DEF-shin.L.001", "DEF-shin.L", "CC_Base_L_CalfTwist", "PLRA"],
    ["DEF-knee_share.L", "DEF-shin.L", "CC_Base_L_KneeShareBone", "PLRA"],
    ["DEF-foot.L", "DEF-shin.L.001", "CC_Base_L_Foot", "PLRA"],
    ["DEF-toe.L", "DEF-foot.L", "CC_Base_L_ToeBase", "PLRA"],
    # Left Foot:
    ["DEF-toe_big.L", "DEF-toe.L", "CC_Base_L_BigToe1", "PLRA"],
    ["DEF-toe_index.L", "DEF-toe.L", "CC_Base_L_IndexToe1", "PLRA"],
    ["DEF-toe_mid.L", "DEF-toe.L", "CC_Base_L_MidToe1", "PLRA"],
    ["DEF-toe_ring.L", "DEF-toe.L", "CC_Base_L_RingToe1", "PLRA"],
    ["DEF-toe_pinky.L", "DEF-toe.L", "CC_Base_L_PinkyToe1", "PLRA"],
    # Left Arm:
    ["DEF-shoulder.L", "DEF-spine.003", "CC_Base_L_Clavicle", "PLRA"],
    ["DEF-upper_arm.L", "DEF-shoulder.L", "CC_Base_L_Upperarm", "PLRXA"],
    ["DEF-upper_arm.L.001", "DEF-upper_arm.L", "CC_Base_L_UpperarmTwist", "PLRA"],
    ["DEF-forearm.L", "DEF-upper_arm.L.001", "CC_Base_L_Forearm", "PLRA"],
    ["DEF-forearm.L.001", "DEF-forearm.L", "CC_Base_L_ForearmTwist", "PLRA"],
    ["DEF-elbow_share.L", "DEF-forearm.L", "CC_Base_L_ElbowShareBone", "PLRA"],
    ["DEF-hand.L", "DEF-forearm.L.001", "CC_Base_L_Hand", "PLRA"],
    # Left Hand Fingers:
    ["DEF-thumb.01.L", "DEF-hand.L", "CC_Base_L_Thumb1", "PLRA"],
    ["DEF-f_index.01.L", "DEF-hand.L", "CC_Base_L_Index1", "PLRA"],
    ["DEF-f_middle.01.L", "DEF-hand.L", "CC_Base_L_Mid1", "PLRA"],
    ["DEF-f_ring.01.L", "DEF-hand.L", "CC_Base_L_Ring1", "PLRA"],
    ["DEF-f_pinky.01.L", "DEF-hand.L", "CC_Base_L_Pinky1", "PLRA"],
    ["DEF-thumb.02.L", "DEF-thumb.01.L", "CC_Base_L_Thumb2", "PLRA"],
    ["DEF-f_index.02.L", "DEF-f_index.01.L", "CC_Base_L_Index2", "PLRA"],
    ["DEF-f_middle.02.L", "DEF-f_middle.01.L", "CC_Base_L_Mid2", "PLRA"],
    ["DEF-f_ring.02.L", "DEF-f_ring.01.L", "CC_Base_L_Ring2", "PLRA"],
    ["DEF-f_pinky.02.L", "DEF-f_pinky.01.L", "CC_Base_L_Pinky2", "PLRA"],
    ["DEF-thumb.03.L", "DEF-thumb.02.L", "CC_Base_L_Thumb3", "PLRA"],
    ["DEF-f_index.03.L", "DEF-f_index.02.L", "CC_Base_L_Index3", "PLRA"],
    ["DEF-f_middle.03.L", "DEF-f_middle.02.L", "CC_Base_L_Mid3", "PLRA"],
    ["DEF-f_ring.03.L", "DEF-f_ring.02.L", "CC_Base_L_Ring3", "PLRA"],
    ["DEF-f_pinky.03.L", "DEF-f_pinky.02.L", "CC_Base_L_Pinky3", "PLRA"],
    # Right Leg:
    ["DEF-thigh.R", "DEF-pelvis", "CC_Base_R_Thigh", "PLRA"],
    ["DEF-thigh.R.001", "DEF-thigh.R", "CC_Base_R_ThighTwist", "PLRA"],
    ["DEF-shin.R", "DEF-thigh.R.001", "CC_Base_R_Calf", "PLRA"],
    ["DEF-shin.R.001", "DEF-shin.R", "CC_Base_R_CalfTwist", "PLRA"],
    ["DEF-knee_share.R", "DEF-shin.R", "CC_Base_R_KneeShareBone", "PLRA"],
    ["DEF-foot.R", "DEF-shin.R.001", "CC_Base_R_Foot", "PLRA"],
    ["DEF-toe.R", "DEF-foot.R", "CC_Base_R_ToeBase", "PLRA"],
    # Right Foot:
    ["DEF-toe_big.R", "DEF-toe.R", "CC_Base_R_BigToe1", "PLRA"],
    ["DEF-toe_index.R", "DEF-toe.R", "CC_Base_R_IndexToe1", "PLRA"],
    ["DEF-toe_mid.R", "DEF-toe.R", "CC_Base_R_MidToe1", "PLRA"],
    ["DEF-toe_ring.R", "DEF-toe.R", "CC_Base_R_RingToe1", "PLRA"],
    ["DEF-toe_pinky.R", "DEF-toe.R", "CC_Base_R_PinkyToe1", "PLRA"],
    # Right Arm:
    ["DEF-shoulder.R", "DEF-spine.003", "CC_Base_R_Clavicle", "PLRA"],
    ["DEF-upper_arm.R", "DEF-shoulder.R", "CC_Base_R_Upperarm", "PLRXA"],
    ["DEF-upper_arm.R.001", "DEF-upper_arm.R", "CC_Base_R_UpperarmTwist", "PLRA"],
    ["DEF-forearm.R", "DEF-upper_arm.R.001", "CC_Base_R_Forearm", "PLRA"],
    ["DEF-forearm.R.001", "DEF-forearm.R", "CC_Base_R_ForearmTwist", "PLRA"],
    ["DEF-elbow_share.R", "DEF-forearm.R", "CC_Base_R_ElbowShareBone", "PLRA"],
    ["DEF-hand.R", "DEF-forearm.R.001", "CC_Base_R_Hand", "PLRA"],
    # Right Hand Fingers:
    ["DEF-thumb.01.R", "DEF-hand.R", "CC_Base_R_Thumb1", "PLRA"],
    ["DEF-f_index.01.R", "DEF-hand.R", "CC_Base_R_Index1", "PLRA"],
    ["DEF-f_middle.01.R", "DEF-hand.R", "CC_Base_R_Mid1", "PLRA"],
    ["DEF-f_ring.01.R", "DEF-hand.R", "CC_Base_R_Ring1", "PLRA"],
    ["DEF-f_pinky.01.R", "DEF-hand.R", "CC_Base_R_Pinky1", "PLRA"],
    ["DEF-thumb.02.R", "DEF-thumb.01.R", "CC_Base_R_Thumb2", "PLRA"],
    ["DEF-f_index.02.R", "DEF-f_index.01.R", "CC_Base_R_Index2", "PLRA"],
    ["DEF-f_middle.02.R", "DEF-f_middle.01.R", "CC_Base_R_Mid2", "PLRA"],
    ["DEF-f_ring.02.R", "DEF-f_ring.01.R", "CC_Base_R_Ring2", "PLRA"],
    ["DEF-f_pinky.02.R", "DEF-f_pinky.01.R", "CC_Base_R_Pinky2", "PLRA"],
    ["DEF-thumb.03.R", "DEF-thumb.02.R", "CC_Base_R_Thumb3", "PLRA"],
    ["DEF-f_index.03.R", "DEF-f_index.02.R", "CC_Base_R_Index3", "PLRA"],
    ["DEF-f_middle.03.R", "DEF-f_middle.02.R", "CC_Base_R_Mid3", "PLRA"],
    ["DEF-f_ring.03.R", "DEF-f_ring.02.R", "CC_Base_R_Ring3", "PLRA"],
    ["DEF-f_pinky.03.R", "DEF-f_pinky.02.R", "CC_Base_R_Pinky3", "PLRA"],
    # Tongue:
    ["DEF-tongue", "DEF-jaw", "CC_Base_Tongue03", "PLRO"],
    ["DEF-tongue.001", "DEF-tongue", "CC_Base_Tongue02", "PLRO"],
    ["DEF-tongue.002", "DEF-tongue.001", "CC_Base_Tongue01", "PLRO"],
    # Teeth:
