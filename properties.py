...
class CC3CharacterCache(bpy.types.PropertyGroup):
    ...
    retarget_hand_correction_angle: bpy.props.FloatProperty(default = 0.0, min=-0.7854, max=0.7854, description="Wrist angle (radians)")
    retarget_thumb_correction_angle: bpy.props.FloatProperty(default = 0.0, min=-0.7854, max=0.7854, description="Thumb spread angle (radians)")
