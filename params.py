...
SHADER_MATRIX = [
    ...
    {   "name": "rl_skin_shader",
        ...
        "ui": [
            ...
            ["PROP", "*Sec. Specular", "skin_secondary_specular_scale", True, "Cavity Map"],
            ["PROP", "*Sec. Roughness", "skin_secondary_roughness_scale", True, "Cavity Map"],
            ["SPACER"],
