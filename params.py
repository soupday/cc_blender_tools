...
SHADER_MATRIX = [
    ...
    {   "name": ["rl_cornea_shader", "rl_eye_shader"],
        ...
        "inputs": [
            ...
            ["Limbus Definition", "", "eye_limbus_definition"],
            ["IOR", "", "eye_ior"],
        ...
        "vars": [
            ...
            ["eye_iris_hsv", 1, "DEF"],
            ["eye_limbus_shading", 0.8, "DEF"],
            ["eye_limbus_definition", 0.0, "DEF"],
        ...
        "ui": [
            ...
            ["PROP", "Iris Brightness", "eye_iris_brightness", False],
            ...
            ["PROP", "*Limbus Definition", "eye_limbus_definition", True],
