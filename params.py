...
SHADER_MATRIX = [
    ...
    {   "name": "rl_skin_shader",
        ...
        "inputs": [
            ...
            ["Secondary Roughness", "", "skin_secondary_roughness"],
        ...
        "textures": [
            ...
            ["Specular Detail Mask", "", "SKINSPECDETAIL", "OFFSET", "", "skin_specular_detail_tiling"],
            ["Normal Map", "", "NORMAL"],
        ...
        "vars": [
            ...
            ["skin_specular_detail_power", 2.0, "DEF"],
            ["skin_specular_detail_tiling", 16, "DEF"],
            ["skin_secondary_specular_scale", 0.6, "DEF"],
            ["skin_secondary_roughness", 0.5, "DEF"],
            ["skin_specular_mix", 0.15, "DEF"],
        ],
        # export variables to update json file on export that need special conversion
        # [json_id, default_value, function, prop_arg1, prop_arg2, prop_arg3...]
        "export": [
        ...
        "ui": [
            ...
            ["PROP", "*Detail Tiling", "skin_specular_detail_tiling", True, "Specular Detail Mask"],
            ...
            ["PROP", "*Sec. Roughness", "skin_secondary_roughness", True, "Specular Detail Mask"],
