...
PROP_MATRIX = [
    ...
    {   "start": "(subsurface_",
        ...
        "groups": [
            ...
            {   "name": "_skin_",
                "inputs": [
                    ["Radius", "skin_sss_radius", "parameters.skin_sss_radius * vars.SSRADIUS_SCALE"],
            ...
            {   "name": "_eye_",
                "inputs": [
                    ["Radius1", "eye_sss_radius", "parameters.eye_sss_radius * vars.SSRADIUS_SCALE"],
                    ["Radius2", "eye_sss_radius", "parameters.eye_sss_radius * vars.SSRADIUS_SCALE"],
            ...
            {   "name": "_hair_",
                "inputs": [
                    ["Radius", "hair_sss_radius", "parameters.hair_sss_radius * vars.SSRADIUS_SCALE"],
            ...
            {   "name": "_teeth_",
                "inputs": [
                    ["Radius1", "teeth_sss_radius", "parameters.teeth_sss_radius * vars.SSRADIUS_SCALE"],
                    ["Radius2", "teeth_sss_radius", "parameters.teeth_sss_radius * vars.SSRADIUS_SCALE"],
            ...
            {   "name": "_tongue_",
                "inputs": [
                    ...
                    ["Radius", "tongue_sss_radius", "parameters.tongue_sss_radius * vars.SSRADIUS_SCALE"],
            ...
            {   "name": "_nails_",
                "inputs": [
                    ["Radius", "nails_sss_radius", "parameters.nails_sss_radius * vars.SSRADIUS_SCALE"],
            ...
            {   "name": "_default_",
                "inputs": [
                    ["Radius", "default_sss_radius", "parameters.default_sss_radius * vars.SSRADIUS_SCALE"],
        ...
        "groups": [
            ...
            {   "name": "skin_body_shader",
                "inputs": [
                    ...
                    ["Subsurface Radius", "skin_sss_radius", "parameters.skin_sss_radius * vars.SSRADIUS_SCALE"],
                    ["Specular Map", "skin_specular"],
                    ["Roughness Power", "skin_roughness_power"],
            ...
            {   "name": "tongue_shader",
                "inputs": [
                    ...
                    ["AO Strength", "tongue_ao"],
                    ["Subsurface Scale", "tongue_sss_scatter"],
                    ["Subsurface Radius", "tongue_sss_radius", "parameters.tongue_sss_radius * vars.SSRADIUS_SCALE"],
                    ["Subsurface Falloff", "tongue_sss_falloff"],
                    ["Front Specular", "tongue_specular_front"],
                    ["Rear Specular", "tongue_specular_rear"],
                    ["Front Roughness", "tongue_roughness_front"],
                    ["Rear Roughness", "tongue_roughness_rear"],
                    ["Normal Strength", "tongue_normal"],
                    ["Micro Normal Strength", "tongue_micronormal"],
                    ["Emissive Color", "tongue_emissive_color"],
                    ["Emission Strength", "tongue_emission_strength"],
                ],
            },
            ...
            {   "name": "teeth_shader",
                "inputs": [
                    ...
                    ["AO Strength", "teeth_ao"],
                    ["Teeth Subsurface Scale", "teeth_teeth_sss_scatter"],
                    ["Gums Subsurface Scale", "teeth_gums_sss_scatter"],
                    ["Subsurface Radius", "teeth_sss_radius", "parameters.teeth_sss_radius * vars.SSRADIUS_SCALE"],
                    ["Subsurface Falloff", "teeth_sss_falloff"],
                    ["Front Specular", "teeth_specular_front"],
                    ["Rear Specular", "teeth_specular_rear"],
                    ["Front Roughness", "teeth_roughness_front"],
                    ["Rear Roughness", "teeth_roughness_rear"],
                    ["Normal Strength", "teeth_normal"],
                    ["Micro Normal Strength", "teeth_micronormal"],
                    ["Emissive Color", "teeth_emissive_color"],
                    ["Emission Strength", "teeth_emission_strength"],
                ],
            },
    ...
    {   "start": "(rl_",
        ...
        "groups": [
            ...
            {   "name": "tongue_shader",
                "inputs": [
                    ["Diffuse Map", "", vars.BASE_COLOR_MAP, "diffuse"],
                    ["Gradient AO Map", "", vars.MOUTH_GRADIENT_MAP, "gradient_ao"],
                    ["AO Mask", "", vars.MOD_AO_MAP, "ao"],
                    ["Metallic Map", "", vars.METALLIC_MAP, "metallic"],
                    ["Roughness Map", "", vars.ROUGHNESS_MAP, "roughness"],
                    ["Normal Map", "", vars.NORMAL_MAP, "normal"],
                    ["Micro Normal Map", "", vars.MOD_MICRONORMAL_MAP, "micro_normal", "tongue_tiling"],
                    ["Emission Map", "", vars.EMISSION_MAP, "emission"],
                ],
            },
            ...
            {   "name": "teeth_shader",
                "inputs": [
                    ["Diffuse Map", "", vars.BASE_COLOR_MAP, "diffuse"],
                    ["Gradient AO Map", "", vars.MOUTH_GRADIENT_MAP, "gradient_ao"],
                    ["Gums Mask", "", vars.TEETH_GUMS_MAP, "gums_mask"],
                    ["AO Mask", "", vars.MOD_AO_MAP, "ao"],
                    ["Metallic Map", "", vars.METALLIC_MAP, "metallic"],
                    ["Roughness Map", "", vars.ROUGHNESS_MAP, "roughness"],
                    ["Normal Map", "", vars.NORMAL_MAP, "normal"],
