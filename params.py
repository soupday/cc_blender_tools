...
SHADER_MATRIX = [
    ...
    {   "name": "rl_eye_occlusion_shader",
        ...
        "ui": [
            ...
            ["PROP", "Hardness", "eye_occlusion_power", True],
            ["PROP", "Strength", "eye_occlusion_strength", True],
            ["PROP", "Top", "eye_occlusion_top_min", True],
            ["PROP", "Top Range", "eye_occlusion_top_range", True],
            ["PROP", "Top Curve", "eye_occlusion_top_curve", True],
            ["PROP", "Bottom", "eye_occlusion_bottom_min", True],
            ["PROP", "Bottom Range", "eye_occlusion_bottom_range", True],
            ["PROP", "Bottom Curve", "eye_occlusion_bottom_curve", True],
            ["PROP", "Inner", "eye_occlusion_inner_min", True],
            ["PROP", "Inner Range", "eye_occlusion_inner_range", True],
            ["PROP", "Outer", "eye_occlusion_outer_min", True],
            ["PROP", "Outer Range", "eye_occlusion_outer_range", True],
            ["SPACER"],
            ["PROP", "2nd Strength", "eye_occlusion_strength2", True],
            ["PROP", "2nd Top", "eye_occlusion_top2_min", True],
            ["PROP", "2nd Top Range", "eye_occlusion_top2_range", True],
            ["SPACER"],
            ["PROP", "Tear Duct Position", "eye_occlusion_tear_duct_position", True],
            ["PROP", "Tear Duct Width", "eye_occlusion_tear_duct_width", True],
    ...
    {   "name": "rl_hair_shader",
        ...
        "ui": [
            ...
            ["PROP", "Anisotropic Color", "hair_anisotropic_color", False],
