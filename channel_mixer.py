...
class CC3MixerBase:
    ...
    color_brightness: bpy.props.FloatProperty(default=0.0, min=-1, max=1, update=lambda s,c: update_mixer(s,c,"color_brightness"))
    color_contrast: bpy.props.FloatProperty(default=0.0, min=-1, max=1, update=lambda s,c: update_mixer(s,c,"color_contrast"))
    color_hue: bpy.props.FloatProperty(default=0.5, min=0, max=1, update=lambda s,c: update_mixer(s,c,"color_hue"))
    color_saturation: bpy.props.FloatProperty(default=1.0, min=0, max=2, update=lambda s,c: update_mixer(s,c,"color_saturation"))
    color_value: bpy.props.FloatProperty(default=1.0, min=0, max=2, update=lambda s,c: update_mixer(s,c,"color_value"))
    metallic_brightness: bpy.props.FloatProperty(default=0.0, min=-1, max=1, update=lambda s,c: update_mixer(s,c,"metallic_brightness"))
    metallic_contrast: bpy.props.FloatProperty(default=0.0, min=-1, max=1, update=lambda s,c: update_mixer(s,c,"metallic_contrast"))
    specular_brightness: bpy.props.FloatProperty(default=0.0, min=-1, max=1, update=lambda s,c: update_mixer(s,c,"specular_brightness"))
    specular_contrast: bpy.props.FloatProperty(default=0.0, min=-1, max=1, update=lambda s,c: update_mixer(s,c,"specular_contrast"))
    roughness_brightness: bpy.props.FloatProperty(default=0.0, min=-1, max=1, update=lambda s,c: update_mixer(s,c,"roughness_brightness"))
    roughness_contrast: bpy.props.FloatProperty(default=0.0, min=-1, max=1, update=lambda s,c: update_mixer(s,c,"roughness_contrast"))
    emission_brightness: bpy.props.FloatProperty(default=0.0, min=-1, max=1, update=lambda s,c: update_mixer(s,c,"emission_brightness"))
    emission_contrast: bpy.props.FloatProperty(default=0.0, min=-1, max=1, update=lambda s,c: update_mixer(s,c,"emission_contrast"))
